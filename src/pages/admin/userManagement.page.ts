...
export class UserManagementPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    this.usernameInput = page.locator('div.oxd-input-group', { hasText: 'Username' }).locator('input');
    this.passwordInput = page
      .locator('div.oxd-input-group')
      .filter({ has: page.locator('label', { hasText: /^Password$/ }) })
      .locator('input');
    this.confirmPasswordInput = page.locator('div.oxd-input-group', { hasText: 'Confirm Password' }).locator('input');
    this.employeeNameInput = page.getByPlaceholder('Type for hints...');
    this.roleDropdown = page.locator('div.oxd-input-group', { hasText: 'User Role' }).locator('.oxd-select-text');
